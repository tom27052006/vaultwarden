...
--
--    `to_regclass` resolves the acknowledgement the same way an unqualified name in this file is
--    resolved, so a search_path split cannot make the check and the statements it guards disagree
